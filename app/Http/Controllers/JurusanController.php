...
class JurusanController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       Jurusan::create($data_jurusan);
        ...
        return redirect('/jurusan/index')->with('sucsess', 'Data Guru Berhasil Ditambah');
    }
    ...
    public function update(Request $request, Jurusan $jurusan)
    {
        ...
        return redirect('/jurusan/index')->with('sucsess', 'Data Guru Berhasil Update');
    }
    ...
    public function destroy(Jurusan $jurusan)
    {
        ...
        $jurusan->delete();
        return redirect('/jurusan/index')->with ('sucsess', 'Data guru berhasil dihapus');
    }
}
