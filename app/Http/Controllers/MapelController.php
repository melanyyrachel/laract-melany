...
class MapelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/mapel/index')->with ('sucsess', 'Data guru berhasil dihapus');
    }
    ...
    public function update(Request $request, Mapel $mapel)
    {
        ...
        return redirect('/mapel/index')->with('sucsess', 'Data Mata Pelajaran Berhasil Update');
    }
    ...
    public function destroy(Mapel $mapel)
    {
        ...
        $mapel->delete();
        return redirect('/mapel/index')->with ('sucsess', 'Data mata pelajaran berhasil dihapus');
    }
}
